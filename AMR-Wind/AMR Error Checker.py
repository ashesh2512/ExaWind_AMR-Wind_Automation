...
file_path = "/Users/srichard/Downloads/AMR-Wind/AMR Base File.inp"
...
def error_checker(file_path):
    ...
    for line in lines:
        ...
        if variable is not None:
            ...
            if 'incflo.godunov_type' in variable:
            ...
            if 'incflo.gravity' in variable:
                ...
                if z_value > -9.8 or z_value < -10:
                    errors.append(f"Error: 'Are you sure you don't want incflo.gravity to be [0 0 -9.81]? It is currently {z_value}'")
            ...
            if 'incflo.density' in variable:
                ...
                if d_value < 1.2 or d_value > 1.3:
                    errors.append(f"Error: 'Are you sure you don't want incflo.density to be 1.225? It is currently {d_value}'")
            ...
            if 'transport.laminar_prandtl' in variable:
                ...
                if d_value < 0.65 or d_value > 0.75:
                    errors.append(f"Error: 'Are you sure you don't want laminar prandtl to be 0.7? It is currently {d_value}'")
